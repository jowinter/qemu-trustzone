...
static struct omap_mcbsp_s *omap_mcbsp_init(target_phys_addr_t base,
                                            qemu_irq txirq, qemu_irq rxirq,
                ...
                const char *core)
{
    ...
    s->microwire = omap_uwire_init(0xfffb3000,
