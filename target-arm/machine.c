...
static const VMStateDescription vmstate_normal_world = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_UINT32(env.cp15.c1_coproc.normal, ARMCPU),
...
const VMStateDescription vmstate_arm_cpu = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_UINT32(env.cp15.c1_coproc.secure, ARMCPU),
        ...
        VMSTATE_UINT32(env.cp15.c2_base0.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base0_hi.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base1.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base1_hi.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_control.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_mask.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_base_mask.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_data, ARMCPU),
        VMSTATE_UINT32(env.cp15.c2_insn, ARMCPU),
        VMSTATE_UINT32(env.cp15.c3.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c5_insn.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c5_data.secure, ARMCPU),
        VMSTATE_UINT32_ARRAY(env.cp15.c6_region, ARMCPU, 8),
        VMSTATE_UINT32(env.cp15.c6_insn.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c6_data.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c7_par.secure, ARMCPU),
        VMSTATE_UINT32(env.cp15.c7_par_hi.secure, ARMCPU),
        ...
        VMSTATE_UINT32(env.cp15.c13_fcse.secure, ARMCPU),
