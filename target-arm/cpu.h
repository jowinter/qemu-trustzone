...
#define MMU_KERNEL_IDX    0  /* Secure world kernel-space */
#define MMU_USER_IDX      1  /* Secure world user-space   */
#define MMU_NS_KERNEL_IDX 2  /* Normal world kernel-space */
#define MMU_NS_USER_IDX   3  /* Normal world user-space   */
